...
from api import posts, categories, tags, archive, siteinfo, menus, auth, interaction, tickets, quick_replies, statistics, ticket_replies, user, staff, system_config
...
app.include_router(system_config.router, prefix="/api", tags=["SystemConfig"])
